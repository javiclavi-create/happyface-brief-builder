...
<button type="button" key={t} onClick={()=>setSourceType(t)} className={`btn ${sourceType===t?'bg-neutral-800':''}`}>{t}</button>
))}
</div>
</div>
<div>
...
<textarea className="input h-60" value={text} onChange={e=>setText(e.target.value)} placeholder="Paste script/brief/article…"></textarea>
</div>
